            ...
            <MDBCol className="text-center pl-0 pr-0">
              <h3 className="about-header text-center pb-sm-3 pt-sm-3">About</h3>
                <div className="about-container">
                  <p className="mx-auto text-center text-sm-center about-text pb-sm-3 pt-sm-3">Loves Coding and learning new technologies. <br/> Travel enthusiast, healthy food addicted. Games and music maniac. <br/> (｡◕‿◕｡)</p>
                </div>
              </MDBCol>
            </MDBRow>
          </MDBContainer> 
